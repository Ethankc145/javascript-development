...
//console.log(yourHouse['0.9708707085142074']);
//console.log(yourHouse[{}]);
//console.log(yourHouse['']);

// Dynamically define an object properties.
const happy = {
    [randomNum]: "This ket name is a random number",
    [str]: "some strings"
};
...
for (keyName in myHouse) {
   //console.log(`The key name is: ${keyName}, and the value is: ${myHouse[keyName]}`);  
}
