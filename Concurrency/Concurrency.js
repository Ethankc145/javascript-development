...
const score = (grade) => {
    switch (grade) {
        ...
        case 'C':
            ...
            break;
        case 'D':
            console.log(`You got an ${grade}, do better`)
            break;
        default:
            console.log(`You got an ${grade}, you didn't study?`);
            break;
    };
}
...
const requestData = (request) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            if(request == 'fulfilled') resolve('The requested was successful')
            if(request == 'failed') resolve('The requested was NOT successful')
        }, 5000);
    })
}
